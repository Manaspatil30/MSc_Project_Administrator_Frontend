...
const StudentUpcomingSessionWidget = () => {
  ...
  useEffect(() => {
    const fetchSessions = async () => {
      try {
        ...
        const response = await axiosInstance.get(`/api/taster-sessions/student/${studentId}`);
...
export default StudentUpcomingSessionWidget;